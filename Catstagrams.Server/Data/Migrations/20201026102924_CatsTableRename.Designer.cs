...
namespace Catstagrams.Server.Data.Migrations
{
    ...
    [Migration("20201026102924_CatsTableRename")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catstagrams.Server.Data.Models.Cat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Catstagrams.Server.Data.Models.Cat", b =>
                {
                    b.HasOne("Catstagrams.Server.Data.Models.User", "User")
                        .WithMany("Cats")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Catstagrams.Server.Data.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
